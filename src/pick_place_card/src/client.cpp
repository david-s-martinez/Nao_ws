...
#include "pick_place_card/MoveJoints.h"
#include <string.h>
...
public:
    ...
    Nao_control() : it_(nh_)
    {
        ...
        move_joints_client = nh_.serviceClient<pick_place_card::MoveJoints>("joint_cartesian_CordOr_movement");
    }
    ...
    bool callMoveJointsService(const std::string &JointName, double PositionMatrix[3], double OrientationMatrix[3], double MaximumVelocity, double ExecutionTime)
    {
        ...
        pick_place_card::MoveJoints srv;
